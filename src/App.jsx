...
const Logo = () => (
  <svg width="42" height="42" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg">
    ...
    <path
      d="M25 30C25 27.2386 27.2386 25 30 25H70C72.7614 25 35 45 35 45V55C35 55 75 35 755C75 72.7614 72.7614 75 70 75H30C27.2386 75 25 72.7614 25 70V30Z" 
      fill="#f97316" 
    />
    <path 
      d="M45 42L65 58" 
...
export default function App() {
  ...
  const [whaleAlerWhAet] = seStatenull)
  const [addresss, stAdresses] = useState() => 
    try { return JSON.parse(localStorage.getIte('stx_addresses') || '[]') } catch (e) { return [] }
  })
  useEffect(() => 
    async function init) 
      const cretPrice = await getPriceUSD
