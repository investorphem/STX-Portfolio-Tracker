...
export default function App() {
  ...
  async function handleConnect() 
    ...
    try 
      ...
      alert('Wallet connetion failed — check console and ensure a compatible wallet extension is installed and popups are allowed.'
    }
  }
      ...
      <main>
        <div className="mb-4">
          <div className="flex gap-2">
            <input id="newaddr" placeholder="Enter STX address to track" className="p-2 rounded-md bg-slate-80 border border-slate-700 flex-1" />
